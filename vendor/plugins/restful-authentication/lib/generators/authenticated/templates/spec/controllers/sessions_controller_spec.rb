...
describe <%= controller_class_name %>Controller do
  ...
  describe "route recognition" do
    it "should generate params from GET /login correctly" do
      {:get => '/login'}.should route_to(:controller => '<%= controller_controller_name %>', :action => 'new')
    end
    it "should generate params from POST /<%= controller_routing_path %> correctly" do
      {:post => '/<%= controller_routing_path %>'}.should route_to(:controller => '<%= controller_controller_name %>', :action => 'create')
    end
    it "should generate params from DELETE /<%= controller_routing_path %> correctly" do
      {:delete => '/logout'}.should route_to(:controller => '<%= controller_controller_name %>', :action => 'destroy')
    end
  end
